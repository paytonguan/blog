...
digraph 为有向图，graph 无向图。一个典型的节点示例如下。
...
将上面的内容保存在一个文件，并以.dot 结尾，例如 tree.dot。在终端执行以下命令即可生成文件。
...
对于二叉树而言，可打开以下代码并保存为 binarytree.gvpr。
...
> [如何画一棵漂亮的二叉树](https://www.yanbinghu.com/2019/04/10/9448.html)  

> [没有IDE如何编译JAVA项目](https://blog.csdn.net/lvshaorong/article/details/73881568)  
