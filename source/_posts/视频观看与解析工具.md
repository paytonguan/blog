...
可用于查看电视直播。下载以下直播源后在 sPlayer 打开即可。
...
在 App Store 上可以下载。下载完成后打开以下链接，点击`点我恢复备份`，在蚂蚁书签中打开，即可导入主流视频网站及解析线路。
...
适用于 Alook 和 iHTTP 浏览器。打开以下链接并下载，导入 alook 文件到 Alook 浏览器或 txt 文件到 iHTTP 浏览器即可，访问视频网站时会自动显示解析源。
...
打开后需要点击设置-通过剪贴板导入口令，导入口令后才能使用。口令可在以下网站获取，注意获取到 json 的原始链接后，需要在前面添加`海阔视界￥home_rule_url￥`才能使用。
...
> [分享国内主流视频网站视频解析接口\(支持VIP视频\)](https://51.ruyo.net/3127.html)  

> [使用GUI You-Get下载主流视频网站资源](https://51.ruyo.net/8877.html)  

> [多数人都不会用，有了这些视频APP，再也不担心失效！](https://mp.weixin.qq.com/s/eP-LvPdlON-J3vUUw04unA)  

> [视频源已补，神器复活！免费畅看全网影视、电视直播、短视频...](https://mp.weixin.qq.com/s/jUVlt664j5bRh7Z2Wzn_8w)  

> [无视加密100%下载，这些神器要把视频网站虐哭了！](https://mp.weixin.qq.com/s/Ki80ETY5TI29l6IdK2qUAw)  

> [一招聚合全网59个平台的直播，斗鱼、虎牙、B站啥都能看（iOS通用）](https://mp.weixin.qq.com/s/buWsGjrkxJSMFc4j9YyQTA)  
