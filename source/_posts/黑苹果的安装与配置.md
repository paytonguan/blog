...
蓝牙驱动需要根据情况自行寻找。本机蓝牙为与无线网卡Atheros AR9565共建的Bluetooth 4.0，修复前关闭按钮无法使用，修复后冷启动失效但热启动可用。
...
无线网卡驱动需要自行寻找适合自己无线网卡的驱动，Intel Wi-Fi卡无解。对于无解的网卡，可以更换网卡、购买黑苹果USB网卡或者将手机作为热点。
